...
from setch.utils.console import console
from setch.utils.icons import CLOCK, GEAR, PENGUIN, PERSON

if not sys_check():
    console.print("[!] Your system is incompatible with setch", style="bold red")
    sys.exit(1)
